...
def tif2array(location):
    ...
    """
    tif_array = gdal.Open(location)
    tif_array= gdal.Open(location)
    band = tif_array.GetRasterBand(1)
    band_array = band.ReadAsArray()
    band_array = band_array.astype(np.float32)
    return band_array

DATA="/Users/Saritha/Desktop/Landsat/"  
loc= os.path.join(DATA, "LC08_L1TP_012030_20150422_20170301_01_T1_B1.tif")
print (loc)
band1_array = tif2array(loc)
band1_array.sum()    
...
metadat = os.path.join(DATA, "LC08_L1TP_012030_20150422_20170301_01_T1_MTL.txt")
var_list = retrieve_meta(metadat)
print(var_list)
...
def lst_calc(location):
    ...
    # Get the different red, nir, and tirs arrays
    red_loc = location + "LC08_L1TP_012030_20150422_20170301_01_T1_B4.tif"
    nir_loc = location + "LC08_L1TP_012030_20150422_20170301_01_T1_B5.tif"
    tirs_loc = location + "LC08_L1TP_012030_20150422_20170301_01_T1_B10.tif"

    red = tif2array(red_loc)
    nir = tif2array(nir_loc)
    tirs = tif2array(tirs_loc)

    # Define constants from metadata
    meta_path = location + "LC08_L1TP_012030_20150422_20170301_01_T1_MTL.txt"
    meta_constants = retrieve_meta(meta_path)
...
bqa = tif2array(os.path.join(DATA, 'LC08_L1TP_012030_20150422_20170301_01_T1_BQA.TIF'))
...
tirs_path = os.path.join(DATA, 'LC08_L1TP_012030_20150422_20170301_01_T1_B10.tif')
ndvi_path = os.path.join(DATA, 'Ramakrishna_ndvi_20150422.tif')
array2tif(tirs_path, ndvi_path, ndvi_filter)
lst_path = os.path.join(DATA, 'Ramakrishna_lst_20150422.tif')
